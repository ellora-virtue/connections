...
export const Tile = ({ word }: TileProps) => {
  ...
  return (
    <AnimatedPressable
      style={[
        animatedTileStyle,
        tw`py-4 ${isSelected ? `bg-[${COLORS.surface.dark}]` : `bg-[${COLORS.surface.light}]`} items-center justify-center rounded-lg px-2 w-[${tileWidth}px] max-w-[${MAX_TILE_WIDTH}px] h-[${TILE_HEIGHT}px]`,
      ]}
